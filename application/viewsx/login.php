    ...
    <div class="thumbnail" style="border-radius: 0;">
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
              <img src="<?php echo site_url('common/album/slide/'.$slide->foto) ?>" style="width: 100%;height: 500px; min-height: 500px;" alt="...">
            </div>
            <?php } ?>
          </div>
...
<footer class="container-fluid footer text-center navbar-inverse">
	<div id="cont-fot">Copyright &copy; 2016 <a href="#">Balai Bahasa Provinsi Jawa Barat</a></div>
