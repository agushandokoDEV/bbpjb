...
?>
<nav class="navbar navbar-default navbar-fixed-top" style="border-bottom: 1px solid #ddd;">
  <!-- Brand and toggle get grouped for better mobile display -->
    <div class="navbar-header">
      ...
      <a href="<?php echo site_url('dashboard') ?>" class="navbar-brand" style="padding: 0 5px 0 5px;margin: 0;height: 70px;"><img  src="<?php echo site_url('assets/app/img/tutwurihandayani.png') ?>" style="height: 60px;width: 100%;margin-top: 5px;"/></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo site_url('setting/foto_slide') ?>"><i class="fa fa-wrench" aria-hidden="true"></i> Setting</a></li>
