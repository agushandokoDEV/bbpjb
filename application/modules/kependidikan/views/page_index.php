        ...
        <div class="row">
            <div class="col-md-10">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Kependidikan</li>
                </ol>
            </div>
            <div class="col-md-2">
                <div class="pull-right"><a href="<?php echo site_url('kependidikan/add') ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Tambah Data kependidikan</a></div>
            </div>
        </div>
        <hr class="hr"/>
...
$(document).ready(function() {
  ...
  table = $('#dt_tbl').DataTable({ 
    ...
    "ajax": {
        "url": "<?php echo site_url('kependidikan/ajax_data')?>",
        "type": "POST"
    },
...
function hapus(id,fl){
    $.confirm({
        ...
        confirm: function(){
            $.post('<?php echo site_url('kependidikan/hapus') ?>',{key:id,fl:fl},function(r){
