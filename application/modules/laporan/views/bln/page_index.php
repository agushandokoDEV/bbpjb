        ...
        <table class="table table-bordered table-hover" id="dt_tbl">
            ...
            <tbody style="border: none;">
                ...
                <tr>
                    ...
                    <a title="Download <?php echo $m->url.'-'.date('Y-m-d').'.xls' ?>" href="<?php echo site_url('laporan/bulanan/'.$m->url.'/'.$m->id_mapinglap.'/'.date('Y').'/'.date('m')) ?>"><img src="<?php echo site_url('assets/app/img/excel-ico.png') ?>"/></a>
...
<script>
$(function(){
    $('#fbln').val('<?php echo date('m') ?>');
    $('#fthn').val('<?php echo date('Y') ?>');
});
function btn_sub(){
