...
class Import_data extends Userauth {
    ...
    private $filenamexl='template-seminar.xls';
    ...
    public function index(){
        $data['total_data']=$this->M_seminar->get_total();
        $data['total_import']=$this->M_seminar->get_total('1');
            ...
            if($excel['name'] == $this->filenamexl){
                ...
                {   
                    ...
                    for($mulai=$this->mulai_rowxl; $mulai<=count($cells); $mulai++){
                        ...
                        $dt=array(
                            'nama_seminar'=>$cells[$mulai]['B'],
                            'pemateri'=>$cells[$mulai]['C'],
                            'tgl_seminar'=>$tgl_pelaksanaan,
                            'tgl_pelaksanaan'=>$tgl_pelaksanaan,
                            'tempat'=>$cells[$mulai]['E'],
                            'lokasi'=>$cells[$mulai]['F'],
