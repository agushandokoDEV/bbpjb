...
class Import_data extends Userauth {
    ...
    private $filenamexl='template-penyusunan_kamus.xls';
    ...
    public function index(){
        $data['total_data']=$this->M_kamus->get_total();
        $data['total_import']=$this->M_kamus->get_total('1');
