...
class M_kegiatan extends CI_Model{
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=t_kegiatan.id_kabkot','LEFT');
        $this->db->where('t_kegiatan.user_input',$this->session->username);
		$i = 0;
