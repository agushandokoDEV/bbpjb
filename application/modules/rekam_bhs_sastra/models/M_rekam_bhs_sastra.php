...
class M_rekam_bhs_sastra extends CI_Model{
    
    private $table = "rekam_bhs_sastra";
    private $column=array('id_rekam_bhs','nama_kota','judul','penyusun','tgl_mulai','tgl_selesai','lokasi','nara_sumber','genre','narasi');
    private $order = array('judul' => 'ASC');
    private $pk='id_rekam_bhs';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=rekam_bhs_sastra.id_kabkot','LEFT');
        $this->db->where('rekam_bhs_sastra.user_input',$this->session->username);
		$i = 0;
