		...
		if ($this->input->is_ajax_request()){
           $list = $this->M_kabkot->get_datatables();
            ...
            foreach ($list as $val) {
                ...
                $action='<a class="btn btn-fill btn-sm btn-info" href="'.base_url("master_data/kabkot/upd/".$val->id_kabkot).'" title="Edit"><i class="fa fa-edit"></i></a>';
                if($role == '1'){
                    $action .='
