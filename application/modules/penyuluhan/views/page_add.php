...
<div class="card">
    ...
    <div class="content">
        <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('penyuluhan/do_add') ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea rows="2" name="nama_keg" class="form-control" placeholder="....."></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Kategori :</label>
            <div class="col-sm-10">
              <input type="text" name="kat" class="form-control" placeholder="....."/>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea rows="2" name="narasumber" class="form-control" placeholder="....."></textarea>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="sasaran" class="form-control" placeholder="....."/>
            </div>
          </div>
          <div class="form-group">
