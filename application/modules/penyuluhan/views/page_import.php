...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="fa fa-cloud-upload bg-bulet bg-info"></i> Import data penyuluhan</h4>
                <ol class="breadcrumb">
                  <li><a href="<?php echo site_url('dashboard') ?>">Home</a></li>
                  <li class="active">Pengembangan</li>
                  <li class="active"><a href="<?php echo site_url('penyuluhan') ?>">Penyuluhan</a></li>
            ...
            <div class="content">
                <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('penyuluhan/import_data/import_data') ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <a id="btn-back" class="btn btn-danger" href="<?php echo site_url('penyuluhan') ?>">Kembali</a>
                    </div>
                  </div>
                </form>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="fa fa-list bg-bulet bg-warning"></i> Data penyuluhan</h4>
                <hr class="hr"/>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="<?php echo site_url('penyuluhan/import_data/del_import') ?>">
