...
class Import_data extends Userauth {
    ...
    private $filenamexl='template-festival.xls';
    ...
    public function index(){
        $data['total_data']=$this->M_festival->get_total();
        $data['total_import']=$this->M_festival->get_total('1');
                ...
                {   
                    ...
                    for($mulai=$this->mulai_rowxl; $mulai<=count($cells); $mulai++){
                        ...
                        $dt=array(
                            ...
                            //'tgl'=>$this->set_date($cells[$mulai]['F']),
                            'jum_peserta'=>$cells[$mulai]['F'],
                            'pemenang'=>$cells[$mulai]['G'],
                            'lokasi'=>$cells[$mulai]['H'],
                            'stts_import'=>1,
