...
class M_festival extends CI_Model{
    
    private $table = "t_festival";
    private $column=array('id_festival','nama_kota','tgl_pelaksanaan','nama','tempat','jum_peserta','pemenang','lokasi');
    private $order = array('nama' => 'DESC');
    private $pk='id_festival';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=t_festival.id_kabkot','LEFT');
        $this->db->where('t_festival.user_input',$this->session->username);
		$i = 0;
