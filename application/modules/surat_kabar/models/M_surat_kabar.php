...
class M_surat_kabar extends CI_Model{
    
    private $table = "surat_kabar";
    private $column=array('jdl_tulisan','tgl_pelaksanaan','penulis','nm_surat_kbr','tgl_terbit','rubrik');
    private $order = array('nama' => 'ASC');
    private $pk='id_surat_kbr';
