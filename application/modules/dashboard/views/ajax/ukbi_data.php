          ...
          <div class="media-body">
            <table class="table table-bordered table-hover" id="dt_tbl">
                ...
                <tbody style="border: none;">
                    ...
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $val->jenis_pengajuan ?></td>
                        <td><?php echo $val->lokasi_pengajuan ?></td>
                        <td><?php echo $val->materi_pengajuan ?></td>
                        <td><?php echo $val->kat_peserta ?></td>
                        <td><?php echo $val->jum_peserta ?></td>
                        <td><?php echo $val->hasil_pengajuan ?></td>
                        <td><?php echo tanggal($val->tgl_pelaksanaan) ?></td>
                        <td><?php echo tanggal($val->tgl_pengajuan) ?></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
