...
class M_duta_bahasa_pelajar extends CI_Model{
    
    private $table = "duta_bahasa";
    private $column=array('id_duta_bhs','tahun','tempat','lokasi','jum_peserta','pemenang','asal_pddkn','ket_juara');
    ...
    function get_row($field,$val)
    {
        ...
        $this->db->where('duta_bahasa.kat','pelajar');
