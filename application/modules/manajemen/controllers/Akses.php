...
class Akses extends Userauth {
	...
	public function index()
	{
        ...
        $data['sub_akses']=$this->getAksesx($ro);
		$data['role']=$this->m_akses->get_role();
		$data['id']=$ro;
		$this->load->view('akses/page_index', $data);
		//$this->load->view('page_index', $data);
	}
    public function get_d()
	{
		$ro=$this->input->post('role');
		...
		$data['role']=$rl;
		$data['id']=$ro;
		$this->load->view('akses/page_load', $data);
		//$this->load->view('page_index', $data);
	}
    ...
    function getAksesx($ro)
	{
		//$ro='1';
        $menu=$this->m_akses->getheadAkses();
		$arr=array();
        $n1=0;
		foreach($menu as $menu)
		{
