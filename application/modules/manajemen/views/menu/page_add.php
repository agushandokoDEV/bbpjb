...
<div class="card">
    ...
    <div class="content">
        <form action="<?php echo base_url('manajemen/menu/do_add') ?>" method="post" id="form-add">
            <div class="form-group">
                <label>Nama Menu</label>
                <input type="text" name="nm_menu" placeholder="Nama Menu" class="form-control">
            </div>
            <div class="form-group">
                <label>Icon</label>
                <input type="text" name="icon" placeholder="Ico" class="form-control">
            </div>
            <div class="form-group">
                <label>Controllers</label>
                <input type="text" name="controllers" placeholder="Controllers" class="form-control">
            </div>
            <div class="form-group">
                <label>Function</label>
                <input type="text" placeholder="Function" name="function" class="form-control">
            </div>
            <div class="form-group">
                <label>SUb</label>
