    ...
    <div class="content">
        ...
        <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('manajemen/users/do_upd') ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php if($dt_row->status == '0'){ ?>
              <input type="hidden" name="status" value="<?php echo $dt_row->status ?>"/>
              <input class="form-control" type="text" value="Belum aktivasi" readonly/>
              <?php }else{?>
...
$(document).ready(function() {
    $('#status').val('<?php echo $dt_row->status ?>');
