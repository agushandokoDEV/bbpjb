...
class M_jurnal extends CI_Model{
    ...
    private $column=array('id_majalah','judul','bln_pelaksanaan','tim_redaksi','volume','no_issn','lingkup','akreditasi','penerbit','info_produk');
    ...
    private function _get_datatables_query()
	{
		...
		$this->db->where('t_majalah.kat','j');
        $this->db->where('t_majalah.user_input',$this->session->username);
