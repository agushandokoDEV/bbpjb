...
class M_bahan_ajar extends CI_Model{
    
    private $table = "bahan_ajar";
    private $column=array('id_bahan_ajar','nama_kota','tgl_pelaksanaan','judul','kat','nama_penyusun','thn_penyusun','tingkat','sasaran','tema','sumber_bahan');
    private $order = array('nama' => 'ASC');
    private $pk='id_bahan_ajar';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=bahan_ajar.id_kabkot','LEFT');
        $this->db->where('bahan_ajar.user_input',$this->session->username);
		$i = 0;
