...
class Import_data extends Userauth {
    ...
    private $filenamexl='template-duta_bahasa.xls';
    private $mulai_rowxl=8;
    
    function __construct(){
	   parent::__construct();
       $this->load->model('M_duta_bahasa');
    ...
    public function index(){
        $data['total_data']=$this->M_duta_bahasa->get_total();
        $data['total_import']=$this->M_duta_bahasa->get_total('1');
