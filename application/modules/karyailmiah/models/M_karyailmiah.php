...
class M_karyailmiah extends CI_Model{
    ...
    private $table = "t_karyailmiah";
    private $column=array('id_karyailmiah','jenis','judul','bln_pelaksanaan','penulis','prodi','perguruan_t');
    private $order = array('jenis' => 'ASC');
    private $pk='id_karyailmiah';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->where('user_input',$this->session->username);
        //$this->db->join('t_kabkot','t_kabkot.id_kabkot=t_karyailmiah.id_kabkot','LEFT');
		$i = 0;
