...
class M_literasi extends CI_Model{
    
    private $table = "t_literasi";
    private $column=array('id_literasi','nama_kota','tgl_pelaksanaan','judul','penyusun','tingkatan','tema','sumber_bahan');
    private $order = array('judul' => 'DESC');
    private $pk='id_literasi';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=t_literasi.id_kabkot','LEFT');
        $this->db->where('t_literasi.user_input',$this->session->username);
		$i = 0;
