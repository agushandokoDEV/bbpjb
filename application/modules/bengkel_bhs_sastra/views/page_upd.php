...
<div class="card">
    ...
    <div class="content">
        ...
        <script>
        $(function(){
            $('#kabkot').val('<?php echo $dt_bhs->id_kabkot ?>');
        });
        </script>
        <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('bengkel_bhs_sastra/do_upd') ?>">
          <input type="hidden" name="id_bhs" value="<?php echo $dt_bhs->id_bhs_sastra ?>"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control dp" name="tgl_pelaksanaan" placeholder="....." value="<?php echo $dt_bhs->tgl_pelaksanaan ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Nama Kegiatan :</label>
            <div class="col-sm-10">
              <input type="text" name="nama_keg" class="form-control" value="<?php echo $dt_bhs->nama_keg ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Kategori :</label>
            <div class="col-sm-10">
              <input type="text" name="kat" class="form-control" value="<?php echo $dt_bhs->kat ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Mulai :</label>
            <div class="col-sm-10">
              <input type="text" class="form-control dp" name="tgl_mulai" placeholder="....." value="<?php echo $dt_bhs->tgl_mulai ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Selesai :</label>
            <div class="col-sm-10">
              <input type="text" class="form-control dp" name="tgl_selesai" placeholder="....." value="<?php echo $dt_bhs->tgl_selesai ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Pematri :</label>
            <div class="col-sm-10">
              <input type="text" name="pematri" class="form-control" value="<?php echo $dt_bhs->pematri ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Jumlah Peserta :</label>
            <div class="col-sm-10">
              <input type="text" name="jum_peserta" class="form-control" value="<?php echo $dt_bhs->jum_peserta ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Peserta :</label>
            <div class="col-sm-10">
              <input type="text" name="peserta" class="form-control" value="<?php echo $dt_bhs->peserta ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Nama Lembaga :</label>
            <div class="col-sm-10">
              <input type="text" name="nama_lembaga" class="form-control" value="<?php echo $dt_bhs->nama_lembaga ?>"/>
            </div>
          </div>
          <div class="form-group">
