...
class M_penelitian extends CI_Model{
    ...
    private $table = "t_penelitian";
    private $column=array('nama_kota','judul','tahun','lokasi','peneliti','publikasi','thn_terbit');
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=t_penelitian.id_kabkot','LEFT');
		$i = 0;
