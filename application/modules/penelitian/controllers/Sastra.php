...
class Sastra extends Userauth{
    ...
    public function add(){
		$data['dt_kabkot']=$this->M_pen_sastra->get_kabkot();
        $this->load->view("sastra/page_add",$data);
	}
    ...
    public function do_upd(){
		if($this->input->method() == "post"){
            ...
            $this->M_pen_sastra->get_upd($id,$data);
            $this->M_pen_sastra->upd_tgl_input($id,$tgl_pelaksanaan);
    ...
    public function hapus(){
		if($this->input->is_ajax_request()){
            ...
            $this->M_pen_sastra->del_lap_id($key);
