...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="fa fa-cloud-upload bg-bulet bg-info"></i> Import data penelitian bahasa</h4>
                <ol class="breadcrumb">
                  <li><a href="<?php echo site_url('dashboard') ?>">Home</a></li>
                  <li class="active">Pengembangan</li>
                  <li class="active"><a href="<?php echo site_url('penelitian/bahasa') ?>">Penelitian bahasa</a></li>
            ...
            <div class="content">
                <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('penelitian/import_data/penbas_import') ?>" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">File upload</label>
                    <div class="col-sm-10">
                      <input type="hidden" name="kat" value="bahasa"/>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <a id="btn-back" class="btn btn-danger" href="<?php echo site_url('penelitian/bahasa') ?>">Kembali</a>
                    </div>
                  </div>
                </form>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="fa fa-list bg-bulet bg-warning"></i> Data penelitian bahasa</h4>
                <hr class="hr"/>
            </div>
            
            <div class="content">
                <h4 class="text-center"><i>Total data keseluruhan : <?php echo $total_bahasa ?></i></h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="<?php echo site_url('penelitian/import_data/del_penbas') ?>">
        <input type="hidden" name="kat" value="bahasa"/>
