...
<div class="card">
    <div class="header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="<?php echo site_url('penelitian/bahasa') ?>">Penelitian Sastra</a></li>
    ...
    <div class="content">
        ...
        <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('penelitian/bahasa/do_upd') ?>">
