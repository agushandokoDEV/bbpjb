...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="fa fa-cloud-upload bg-bulet bg-info"></i> Import data penelitian sastra</h4>
                <ol class="breadcrumb">
                ...
                <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('penelitian/import_data/penbas_import') ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <a id="btn-back" class="btn btn-danger" href="<?php echo site_url('penelitian/sastra') ?>">Kembali</a>
                    </div>
                  </div>
                </form>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="fa fa-list bg-bulet bg-warning"></i> Data penelitian sastra</h4>
                <hr class="hr"/>
            </div>
            
            <div class="content">
                <h4 class="text-center"><i>Total data keseluruhan : <?php echo $total_sastra ?></i></h4>
