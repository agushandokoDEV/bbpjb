...
class Pelatihan_mutu_pegawai extends Userauth {
    ...
    public function add(){
        $data['dt_kabkot']=$this->M_mutu->get_kabkot();
    ...
    public function do_add(){
		if($this->input->method() == "post"){
            ...
            $tahun=$this->exp_date($tgl_latihan);
            $data=array(
    ...
    public function do_upd(){
		if($this->input->method() == "post"){
            ...
            $this->M_mutu->get_upd($id,$data);
            $this->M_mutu->upd_tgl_input($id,$tgl_latihan);
