...
class M_ensiklopedi extends CI_Model{
    
    private $table = "t_ensiklopedi";
    private $column=array('id_ensiklopedi','nama_kota','tahun','kat','judul','tim_redaksi','lingkup','info_produk');
    private $order = array('judul' => 'ASC');
    private $pk='id_ensiklopedi';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=t_ensiklopedi.id_kabkot','LEFT');
        $this->db->where('t_ensiklopedi.user_input',$this->session->username);
		$i = 0;
