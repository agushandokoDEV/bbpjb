...
<div class="row">
    <div class="col-md-8">
        <?php if($p != null){ ?>
            <div class="card">
                <div class="header">
                    <h4 class="title"><span class="glyphicon glyphicon-info-sign"></span> Informasi</h4>
                    <hr class="hr"/>
                </div>
                <div class="content">
            ...
            <div class="card">
                <div class="header">
                    <h4 class="title"><i class="glyphicon glyphicon-comment"></i> (<span id="jumkom"><?php echo $dt_jumkom->jumlah; ?></span>) Komentar</h4>
                    <hr class="hr"/>
                </div>
                <div class="content">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="header">
                <h4 class="title"><i class="glyphicon glyphicon-user bg-bulet bg-app"></i> Form Komentar</h4>
                <hr class="hr"/>
            </div>
            <div class="content">
