...
class M_terbitan extends CI_Model{
    ...
    private $column=array('id_terbitan','kat_terbitan','penulis','no_isbn','thn_terbit','deskripsi','info_produk');
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->where('user_input',$this->session->username);
        //$this->db->join('t_kabkot','t_kabkot.id_kabkot=t_terbitan.id_kabkot','LEFT');
		$i = 0;
