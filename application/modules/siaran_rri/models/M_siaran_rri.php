...
class M_siaran_rri extends CI_Model{
    
    private $table = "t_siaran_rri";
    private $column=array('id_siaran','penulis_naskah','judul_naskah','tgl_pelaksanaan','tgl_perekaman','tgl_disiarkan');
    private $order = array('judul_naskah' => 'ASC');
    private $pk='id_siaran';
