...
class M_jambore extends CI_Model{
    
    private $table = "t_jambore";
    private $column=array('id_jambore','waktu','tempat','utusan','nama_panitia','jenis_tampilan');
    private $order = array('id_jambore' => 'DESC');
    private $pk='id_jambore';
