...
class Import_data extends Userauth {
    ...
    private $filenamexl='template-bipa.xls';
    ...
    public function index(){
        $data['total_data']=$this->M_bipa->get_total();
        $data['total_import']=$this->M_bipa->get_total('1');
            ...
            if($excel['name'] == $this->filenamexl){
                ...
                {   
                    ...
                    for($mulai=$this->mulai_rowxl; $mulai<=count($cells); $mulai++){
                        $ar[]=$cells[$mulai];
                        $tgl_pelaksanaan=$this->set_date($cells[$mulai]['E']);
                        
                        $dt=array(
                            'nama_pembelajar'=>$cells[$mulai]['B'],
                            'negara'=>$cells[$mulai]['C'],
                            'tingkat'=>$cells[$mulai]['D'],
