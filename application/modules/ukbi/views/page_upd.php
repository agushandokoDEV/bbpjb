    ...
    <div class="content">
        ...
        <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('ukbi/do_upd') ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control dp" name="tgl_pelaksanaan" placeholder="....." value="<?php echo $dt_ukbi->tgl_pelaksanaan ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Lokasi Pengujian :</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Jenis Pengujian :</label>
            <div class="col-sm-10">
              <input type="text" name="jenis_pengajuan" class="form-control" placeholder="....." value="<?php echo $dt_ukbi->jenis_pengajuan ?>"/>
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Materi Pengujian :</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Hasil Pengujian :</label>
            <div class="col-sm-10">
...
$(document).ready(function() {
    ...
    .on('changeDate', function(e) {
        $('#form-add').formValidation('revalidateField', 'tgl_pengajuan');
