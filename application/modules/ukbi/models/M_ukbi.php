...
class M_ukbi extends CI_Model{
    
    private $table = "t_ukbi";
    private $column=array(
                        ...
                        'lampiran',
                        'ket');
    private $order = array('lokasi_pengajuan' => 'ASC');
    private $pk='id_ukbi';
    ...
    private function _get_datatables_query()
	{
        ...
        $this->db->join('t_kabkot','t_kabkot.id_kabkot=t_ukbi.id_kabkot','LEFT');
        $this->db->where('t_ukbi.user_input',$this->session->username);
		$i = 0;
