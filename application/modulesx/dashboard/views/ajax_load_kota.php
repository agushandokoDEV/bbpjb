...
<div class="card">
    ...
    <div class="content">
        ...
        <hr class="hr"/>
        <?php }?>
        <?php if($jum_keg->jumlah > 10){ ?>
        <a href="<?php echo site_url('kegiatan/kota/index/'.$dt_kota->id_kabkot.'/'.$thn) ?>" class="btn btn-sm btn-default" style="width: 100%;">Tampilkan lebih banyak</a>
        <?php }}else{?>
        <p class="error"><i><span class="glyphicon glyphicon-info-sign"></span> Kegiatan tidak tersedia..</i></p>
        <?php }?>
    </div>
</div>