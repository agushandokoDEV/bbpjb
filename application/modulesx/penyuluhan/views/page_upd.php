    ...
    <div class="content">
        ...
        <form id="form-add" class="form-horizontal" method="POST" action="<?php echo site_url('penyuluhan/do_upd') ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="nama_keg" class="form-control" placeholder="....." value="<?php echo $dt_row->nama_keg ?>"/>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="narasumber" class="form-control" placeholder="....." value="<?php echo $dt_row->narasumber ?>"/>
            </div>
          </div>
          <div class="form-group">
