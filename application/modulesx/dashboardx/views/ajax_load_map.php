...
<img class="mapjabar" id="Image-Maps-Com-image-maps-2016-03-27-231822" src="http://balai.ajarin.id/common/map/jabar.png" border="0" width="918" height="500" orgWidth="918" orgHeight="500" usemap="#image-maps-2016-03-27-231822" alt="" />
...
?>
<area data-maphilight='{"fillColor":"<?php echo $color ?>","stroke":false}' onclick="get_data('<?php echo $map->id_kabkot ?>')" data-toggle="tooltip" alt="<?php echo ucwords($map->nama_kota) ?>" title="<?php echo ucwords($map->nama_kota) ?>" shape="poly" coords="<?php echo $map->coord ?>" style="outline:none;" target="_self"     />
<?php }?>
