...
<div class="card">
    <div class="header">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="pull-right"><a href="<?php echo site_url('jurnal/add') ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Tambah Data Jurnal</a></div>
            </div>
        </div>
        <hr class="hr"/>
