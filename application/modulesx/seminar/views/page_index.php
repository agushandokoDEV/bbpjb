...
<div class="card">
    <div class="header">
        <h4 class="title"><i class="fa fa-sitemap bg-bulet bg-app"></i> Seminar</h4>
        <div class="row">
            <div class="col-md-10">
                <ol class="breadcrumb">
            ...
            <div class="col-md-2">
                <div class="pull-right"><a href="<?php echo site_url('seminar/add') ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Tambah Role</a></div>
            </div>
        </div>
        <hr class="hr"/>
