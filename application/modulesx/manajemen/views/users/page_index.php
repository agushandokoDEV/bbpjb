...
<div class="card">
    <div class="header">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="pull-right"><a href="<?php echo site_url('manajemen/users/add') ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Tambah Users</a></div>
            </div>
        </div>
        <hr class="hr"/>
...
$(document).ready(function() {
  ...
  table = $('#dt_tbl').DataTable({ 
    ...
    "ajax": {
        "url": "<?php echo site_url('manajemen/users/ajax_list')?>",
        "type": "POST"
    },
...
function hapus(id){
    $.confirm({
        ...
        confirm: function(){
            $.post('<?php echo site_url('manajemen/users/hapus') ?>',{key:id},function(r){
