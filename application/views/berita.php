...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a href="<?php echo site_url() ?>"><img class="navbar-brand" src="<?php echo site_url('assets/app/img/tutwurihandayani.png') ?>" style="width: 100%;height: 70px;padding: 0;" /></a>
    </div>
...
<div class="container main-content" style="font-family: sans-serif;" style="width: 50%;">
        <?php if($b){?>
        
        <div class="thumbnail" style="padding: 5px 10px 5px 10px;">
            <div style="min-height: 400px;">
                <h2 class="media-heading" style="margin-top: 10px;"><span class="glyphicon glyphicon-globe"></span> <?php echo $b->judul ?></h2>
                <p class="label label-danger" style="font-size: 10px;"><span class="glyphicon glyphicon-calendar"></span> <?php echo tanggal($b->tgl) ?></p>
                <img class="media-object img-thumbnail" src="<?php echo $b->url_img ?>"  data-holder-rendered="true" style="width:100%;border-radius: 0;margin-top: 10px; max-height: 500px;">
                <p style="min-height:50px;margin-top: 5px;"><?php echo $b->isi ?></p>
            </div>
