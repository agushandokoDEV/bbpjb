...
<html lang="en">
  <head>
    ...
    <title>Balai Bahasa Jawa Barat</title>
  ...
  <body>
    <div class="container top-content">
        ...
        $brand='';
        ?>
        <div class="thumbnail no-radius thub-nav">
            <div class="text-center"><img src="<?php echo site_url('assets/app/img/tutwurihandayani.png') ?>" style="width: 10%;height: 50px;padding: 0;" /></div>
            <h3 class="balai-brand text-center">BALAI BAHASA JAWA BARAT</h3>
