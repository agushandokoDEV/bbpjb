    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="header bg-default">
                <h4 class="title"><span class="glyphicon glyphicon-globe"></span> <?php echo htmlspecialchars($berita->judul); ?></h4>
                <hr class="hr"/>
            </div>    
            ...
            <div class="content">
                ...
                <p style="margin-top: 20px;text-indent: 50px;"><?php echo htmlspecialchars($berita->isi); ?></p>
            </div>
        </div>
        <?php }else{?>
